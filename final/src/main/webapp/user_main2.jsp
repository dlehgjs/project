...
<%} %>
	<nav class="nav nav-pills flex-column flex-sm-row">
		  <a class="flex-sm-fill text-sm-center nav-link" href="user_main1.jsp">전체상품</a>
		  <a class="flex-sm-fill text-sm-center nav-link active" aria-current="page" href="user_main2.jsp">인기상품</a>
		  <a class="flex-sm-fill text-sm-center nav-link" href="user_main3.jsp">신상품</a>
	</nav>
<%@ include file="user_cont2.jsp"%>
